 ...
 * "Grocery" (Newsreader italic, tomato) — exactly paralleling the
 * Recipe Book's "Recipe Book" line. The monogram is a tomato list
 * card with a checked-off top row + olive sprig, drawn from design
 * tokens so it always tracks the palette.
 */
...
/**
 * The tomato grocery-list monogram alone. Drawn from design tokens
 * so it always tracks the palette.
 */
